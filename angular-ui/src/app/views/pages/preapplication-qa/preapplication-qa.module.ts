...
@NgModule({
	declarations: [PreapplicationQaComponent
		//,CertificateDialogComponent,QuestionsAnswerDialogComponent
	],
	imports: [
		CommonModule,
		MatInputModule,
		...
		RouterModule.forChild([
			{
				path: '',			
				component: PreapplicationQaComponent
			},
	...
	//	QuestionsAnswerService,
		LayoutUtilsService,
		//QuestionsAnswerDialogComponent,
...
export class PreapplicationQAModule { }
